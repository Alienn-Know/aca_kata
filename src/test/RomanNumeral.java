package test;
 ...
 class RomanNumeral {// без модификатора доступа ( по условию тз )

     /* Этот класс позаимствовал отсюда =)
        https://math.hws.edu/eck/cs124/javanotes3/c9/ex-9-3-answer.html
    ...
    private static int[] numbers = { 1000, 900, 500, 400, 100,
            90, 50, 40, 10, 9, 5, 4, 1 };
